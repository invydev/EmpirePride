...
local function StartFishWebhook()
    ...
    task.spawn(function()
        SendWebhook({
            ...
            avatar_url = "https://files.catbox.moe/xx6f4u.jpg",
            embeds = {{
                title = "HALLO SIR, **" .. LocalPlayer.Name .. "** activated Webhook",
...
-- CONFIG
---------------------------------------------------------------------
local ICON_ID = "https://files.catbox.moe/xx6f4u.jpg" -- GANTI dengan icon kamu
...
local TabPlayer = Window:Tab({ Title = "Dashboard", Icon = "user" })
local TabFishing = Window:Tab({ Title = "Blantat Mode", Icon = "fish" })
...
sectionServer:Button({
    ...
    Callback = function()
        ...
        local myScript = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/invydev/EmpirePride/refs/heads/main/main.lua"))()'
